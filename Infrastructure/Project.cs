namespace PB.Infrastructure
{
    ...
    public class Project
    {
        ...
        public ICollection<University> tagetGroup { get; set; } = new HashSet<University>(); //FK's
        
        public ICollection<Student> CollabStudents { get; set; } = new HashSet<Student>(); //FK's
