...
public class ApplicationControllerTests
{
    ...
    public async Task Create_creates_application()
    {
        ...
        var created = new ApplicationDetailsDTO(1, 1,1,null, "title", "Test");
        var repository = new Mock<IApplicationRepository>();
        repository.Setup(m => m.CreateAsync(toCreate)).ReturnsAsync(created);
        var controller = new ApplicationController(logger.Object, repository.Object, projectRepo.Object);
    ...
    public async Task Get_given_existing_returns_application()
    {
        ...
        var repository = new Mock<IApplicationRepository>();
        var projectRepo = new Mock<IProjectRepository>();
        var application = new ApplicationDetailsDTO(1, 1, 1, null,"title", "test");
